...
#    Updated: 2016/12/09 19:08:38 by ariard           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
mytest: 
	...
	@ make -C ./libft clean
	@ gcc -c $(FLAGS) $(SRC3)
	@ gcc $(OBJ3) -o $(NAME) -I $(HEADER)

clean-mytest:
	@ rm -rf $(OBJ3)

fclean-mytest: clean-test
	@ rm -f $(NAME)
	@ rm -f Libft/libft.a

re-mytest: fclean-test test
